...
public:		// User declarations
	...
	bool UpdateCountry(const System::UnicodeString AName, const System::UnicodeString ACurrency);
	// Delete country paasado el nombre
	bool DeleteCountry(const System::UnicodeString AName);
};
//---------------------------------------------------------------------------
